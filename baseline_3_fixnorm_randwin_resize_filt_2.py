...
class G2NetDataset(Dataset):
    def __init__(self, df, transform=None, conf=None, train=True):
        ...
        self.wave_transform = [
            CQT1992v2(sr=2048, fmin=10, fmax=512, hop_length=8, bins_per_octave=8, window='flattop'),
            CQT1992v2(sr=2048, fmin=10, fmax=512, hop_length=8, bins_per_octave=8, window='blackmanharris'),
            CQT1992v2(sr=2048, fmin=10, fmax=512, hop_length=8, bins_per_octave=8, window='nuttall')]
